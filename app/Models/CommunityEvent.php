 ...
 * @property numeric|null $ticket_price
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent approvedUpcoming()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent byOrganizer($organizerId)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent eventType($type)
 * @method static \Database\Factories\CommunityEventFactory factory($count = null, $state = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent flagged(\BackedEnum|string $name)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent local($maxDistance = 60)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent notFlagged(\BackedEnum|string $name)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent onlyTrashed()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent publishedPublic()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent query()
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereAutoApproved($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereDeletedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereDescription($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereDistanceFromCorvallis($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereEndTime($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereOrganizerId($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent wherePublishedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereStartTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereTicketPrice($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereTicketUrl($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereTitle($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereTrustPoints($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereVenueAddress($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereVenueName($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent whereVisibility($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withAllTags(\ArrayAccess|\Spatie\Tags\Tag|array|string $tags, ?string $type = null)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withAllTagsOfAnyType($tags)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withAnyTags(\ArrayAccess|\Spatie\Tags\Tag|array|string $tags, ?string $type = null)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withAnyTagsOfAnyType($tags)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withAnyTagsOfType(array|string $type)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withTrashed(bool $withTrashed = true)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withoutTags(\ArrayAccess|\Spatie\Tags\Tag|array|string $tags, ?string $type = null)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|CommunityEvent withoutTrashed()
 * @mixin \Eloquent
 */
