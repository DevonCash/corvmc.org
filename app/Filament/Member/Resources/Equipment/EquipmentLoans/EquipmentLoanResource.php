...
namespace App\Filament\Member\Resources\Equipment\EquipmentLoans;

use App\Filament\Member\Resources\Equipment\EquipmentLoans\Pages\CreateEquipmentLoan;
use App\Filament\Member\Resources\Equipment\EquipmentLoans\Pages\EditEquipmentLoan;
use App\Filament\Member\Resources\Equipment\EquipmentLoans\Pages\ListEquipmentLoans;
use App\Filament\Member\Resources\Equipment\EquipmentLoans\Schemas\EquipmentLoanForm;
use App\Filament\Member\Resources\Equipment\EquipmentLoans\Tables\EquipmentLoansTable;
...
class EquipmentLoanResource extends Resource
{
    ...
    {
        return User::me()?->can('create', EquipmentLoan::class) ?? false;
    }

    public static function canEdit($record): bool
    {
        return User::me()?->can('update', $record) ?? false;
    }

    public static function canDelete($record): bool
    {
        return User::me()?->can('delete', $record) ?? false;
    }

    public static function canView($record): bool
    {
        return User::me()?->can('view', $record) ?? true;
    }
