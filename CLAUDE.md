...
Current modules: bands, equipment, events, finance, kiosk, membership, moderation, space-management, sponsorship, support, volunteering.
...
- **HourLogState**: Interested → Confirmed → CheckedIn → CheckedOut (plus Released); Self-reported: Pending → Approved / Rejected
