<div class="card bg-primary text-primary-content shadow-xl">
    <div class="card-body">
        <div class="flex items-center gap-4 mb-4">
            <x-icon name="tabler-heart-handshake" class="size-12" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="bg-primary-content text-primary rounded-lg p-4">
                <div class="flex items-center gap-2 mb-2">
                    <x-icon name="tabler-microphone" class="size-5" />
            ...
            <div class="bg-primary-content text-primary rounded-lg p-4">
                <div class="flex items-center gap-2 mb-2">
                    <x-icon name="tabler-device-mobile" class="size-5" />
            ...
            <div class="bg-primary-content text-primary rounded-lg p-4">
                <div class="flex items-center gap-2 mb-2">
                    <x-icon name="tabler-tool" class="size-5" />
            ...
            <div class="bg-primary-content text-primary rounded-lg p-4">
                <div class="flex items-center gap-2 mb-2">
                    <x-icon name="tabler-pencil" class="size-5" />
