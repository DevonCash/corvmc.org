    ...
    <div class="navbar bg-base-100 shadow-sm border-b border-base-200">
        <div class="navbar-start">
            <div class="dropdown">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    ...
                    <li><a href="{{ route('practice-space') }}">Practice Space</a></li>
                    <li><a href="{{ route('support') }}">Contribute</a></li>
                    <li><a href="{{ route('volunteer') }}">Volunteer</a></li>
                    <li><a href="{{ route('contact') }}">Contact</a></li>
                </ul>
            </div>
            <a href="{{ route('home') }}" class="btn btn-ghost text-lg font-semibold">
                <div class="text-left leading-tight">
                    <div class="text-primary font-bold">Corvallis</div>
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1">
                ...
                <li><a href="{{ route('support') }}" class="{{ request()->routeIs('support') ? 'active' : '' }}">Contribute</a></li>
                <li><a href="{{ route('volunteer') }}" class="{{ request()->routeIs('volunteer') ? 'active' : '' }}">Volunteer</a></li>
            </ul>
        </div>
        
        <div class="navbar-end">
            <a href="{{ route('support') }}" class="btn btn-primary btn-sm mr-2">Donate</a>
            @auth
                <a href="/member" class="btn btn-ghost btn-sm">Dashboard</a>
            @else
