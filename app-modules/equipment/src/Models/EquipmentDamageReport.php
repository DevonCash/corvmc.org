 ...
 * @property-read EquipmentLoan|null $loan
 ...
 * @method static \CorvMC\Equipment\Database\Factories\EquipmentDamageReportFactory factory($count = null, $state = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|EquipmentDamageReport forEquipment(Equipment $equipment)
...
class EquipmentDamageReport extends Model implements HasMedia
{
     ...
     */
    protected static function newFactory(): \CorvMC\Equipment\Database\Factories\EquipmentDamageReportFactory
    {
        return \CorvMC\Equipment\Database\Factories\EquipmentDamageReportFactory::new();
    }
}
