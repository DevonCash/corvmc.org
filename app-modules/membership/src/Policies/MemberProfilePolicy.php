...
namespace CorvMC\Membership\Policies;
...
class MemberProfilePolicy
{
    ...
    public function viewContact(User $user, MemberProfile $memberProfile): ?bool
    {
        ...
        if ($memberProfile->contact->visibility === \CorvMC\Moderation\Enums\Visibility::Public) {
            return true;
        }

        if ($memberProfile->contact->visibility === \CorvMC\Moderation\Enums\Visibility::Members && $user) {
            return true;
        }
