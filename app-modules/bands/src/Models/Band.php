...
use App\Models\User;
use CorvMC\Bands\Models\Scopes\OwnedBandsScope;
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, BandMember> $activeMembers
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, BandMember> $memberships
 * @property-read int|null $memberships_count
 * @property-read User|null $owner
 * @property-read \Illuminate\Database\Eloquent\Collection<int, BandMember> $pendingInvitations
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Band visibleTo(?User $user = null)
...
class Band extends ContentModel
{
     ...
     */
    protected static function newFactory(): \Database\Factories\BandFactory
    {
