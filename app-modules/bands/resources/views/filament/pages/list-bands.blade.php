        ...
        <div class="w-full">
            <x-filament::input.wrapper>
                <x-filament::input
                    ...
                    placeholder="Search bands by name or location..."
                    class="w-full"
                />
            </x-filament::input.wrapper>
        </div>
        ...
        <div class="relative">
            ...
            <div wire:loading.delay.long class="absolute inset-0 bg-white/75 flex items-center justify-center z-10">
                <div class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-sm text-gray-600">Loading bands...</span>
                </div>
            </div>
            ...
            <div class="grid gap-6"
                ...
                @empty
                    <div class="col-span-full text-center py-12 space-y-2">
                        <x-tabler-music-off class="mx-auto h-12 w-12 text-gray-400" />
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No bands found</h3>
                        <p class="mt-1 text-sm text-gray-500">No bands found matching your criteria – check back soon!</p>
                        <x-filament::button wire:click="clearFilters" color="gray" size="sm">
                            Clear Filters
                        </x-filament::button>
                    </div>
