                                    ...
                                    @switch($activity->event)
                                        @case('created')
                                            <span class="h-8 w-8 rounded-full bg-blue-500 flex items-center justify-center ring-8 ring-white dark:ring-gray-900">
                                                <x-tabler-circle-plus class="h-4 w-4 text-white" />
                                            </span>
                                            @break
                                        @case('updated')
                                            @php
