...
class ReservationWorkflowTest extends TestCase
{
    ...
    public function sustaining_member_pays_for_hours_beyond_free_limit()
    {
        ...
        Reservation::factory()->create([
            ...
            'hours_used' => 3,
            'free_hours_used' => 3,
            'reserved_at' => $pastStart,
            'reserved_until' => $pastEnd,
            'status' => 'confirmed',
        ]);
    ...
    public function conflicting_reservations_are_prevented()
    {
        ...
        ReservationService::createReservation($user2, $overlappingStart, $overlappingEnd);
    }
    ...
    public function user_can_update_their_reservation()
    {
        ...
        $reservation = ReservationService::createReservation($user, $originalStart, $originalEnd);
    ...
    public function user_can_cancel_reservation()
    {
        ...
        $cancelled = ReservationService::cancelReservation($reservation, 'Changed plans');
    ...
    public function business_hours_are_enforced()
    {
        ...
        $this->expectException(\InvalidArgumentException::class);
        ReservationService::createReservation($user, $earlyStart, $earlyEnd);
    }
    ...
    public function duration_limits_are_enforced()
    {
        ...
        $this->expectException(\InvalidArgumentException::class);
        ReservationService::createReservation($user, $start, $end);
    }
    ...
    public function free_hours_reset_monthly()
    {
        ...
        $lastMonthStart = Carbon::now()->subMonth()->startOfMonth()->addDays(15)->setTime(10, 0);
        Reservation::factory()->create([
            'user_id' => $user->id,
            'cost' => 0,
            'hours_used' => 4,
            'free_hours_used' => 4,
            'reserved_at' => $lastMonthStart,
            'reserved_until' => $lastMonthStart->copy()->addHours(4),
            'status' => 'confirmed',
        ]);
        ...
        // Use some hours this month - use a future date within this month
        $start = Carbon::now()->addDays(1)->setTime(9, 0); // 9 AM tomorrow
        $end = $start->copy()->addHours(2);
